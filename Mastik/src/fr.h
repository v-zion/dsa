...
/*
 * Repeatedly flush the monitored sets. Does not return - use with care.
 * Note: This is a temporary interface for the CHES tutorial session.  Better support will be added later.
 */
